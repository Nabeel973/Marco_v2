...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup: function setup() {
    ...
    var profileDetailsValidator = yup__WEBPACK_IMPORTED_MODULE_2__.object().shape({
      fname: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("First name"),
      lname: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Last name"),
      company: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Company"),
      phone: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Contact phone"),
      website: yup__WEBPACK_IMPORTED_MODULE_2__.string().label("Webside"),
      country: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Country"),
      language: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Language"),
      timezone: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Timezone"),
      currency: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Currency")
    });
    var changeEmail = yup__WEBPACK_IMPORTED_MODULE_2__.object().shape({
      emailaddress: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().email().label("Email"),
      confirmemailpassword: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Password")
    });
    var changePassword = yup__WEBPACK_IMPORTED_MODULE_2__.object().shape({
      currentpassword: yup__WEBPACK_IMPORTED_MODULE_2__.string().required().label("Current password"),
      newpassword: yup__WEBPACK_IMPORTED_MODULE_2__.string().min(4).required().label("Password"),
      confirmpassword: yup__WEBPACK_IMPORTED_MODULE_2__.string().min(4).required().oneOf([yup__WEBPACK_IMPORTED_MODULE_2__.ref("newpassword"), null], "Passwords must match").label("Password Confirmation")
    });
...
var _hoisted_538 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  "class": "fs-6 fw-semobold text-gray-600 mb-4"
...
var _hoisted_576 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"card-body border-top px-9 py-9\"><!--begin::Option--><label class=\"form-check form-check-custom form-check-solid align-items-start\"><!--begin::Input--><input class=\"form-check-input me-3\" type=\"checkbox\" name=\"email-preferences1\" value=\"1\"><!--end::Input--><!--begin::Label--><span class=\"form-check-label d-flex flex-column align-items-start\"><span class=\"fw-bold fs-5 mb-0\">Successful Payments</span><span class=\"text-muted fs-6\">Receive a notification for every successful payment.</span></span><!--end::Label--></label><!--end::Option--><!--begin::Option--><div class=\"separator separator-dashed my-6\"></div><!--end::Option--><!--begin::Option--><label class=\"form-check form-check-custom form-check-solid align-items-start\"><!--begin::Input--><input class=\"form-check-input me-3\" type=\"checkbox\" name=\"email-preferences1\" checked value=\"1\"><!--end::Input--><!--begin::Label--><span class=\"form-check-label d-flex flex-column align-items-start\"><span class=\"fw-bold fs-5 mb-0\">Payouts</span><span class=\"text-muted fs-6\">Receive a notification for every initiated payout.</span></span><!--end::Label--></label><!--end::Option--><!--begin::Option--><div class=\"separator separator-dashed my-6\"></div><!--end::Option--><!--begin::Option--><label class=\"form-check form-check-custom form-check-solid align-items-start\"><!--begin::Input--><input class=\"form-check-input me-3\" type=\"checkbox\" name=\"email-preferences1\" value=\"1\"><!--end::Input--><!--begin::Label--><span class=\"form-check-label d-flex flex-column align-items-start\"><span class=\"fw-bold fs-5 mb-0\">Fee Collection</span><span class=\"text-muted fs-6\">Receive a notification each time you collect a fee from sales</span></span><!--end::Label--></label><!--end::Option--><!--begin::Option--><div class=\"separator separator-dashed my-6\"></div><!--end::Option--><!--begin::Option--><label class=\"form-check form-check-custom form-check-solid align-items-start\"><!--begin::Input--><input class=\"form-check-input me-3\" type=\"checkbox\" name=\"email-preferences1\" checked value=\"1\"><!--end::Input--><!--begin::Label--><span class=\"form-check-label d-flex flex-column align-items-start\"><span class=\"fw-bold fs-5 mb-0\">Customer Payment Dispute</span><span class=\"text-muted fs-6\">Receive a notification if a payment is disputed by a customer and for dispute purposes.</span></span><!--end::Label--></label><!--end::Option--><!--begin::Option--><div class=\"separator separator-dashed my-6\"></div><!--end::Option--><!--begin::Option--><label class=\"form-check form-check-custom form-check-solid align-items-start\"><!--begin::Input--><input class=\"form-check-input me-3\" type=\"checkbox\" name=\"email-preferences1\" value=\"1\"><!--end::Input--><!--begin::Label--><span class=\"form-check-label d-flex flex-column align-items-start\"><span class=\"fw-bold fs-5 mb-0\">Refund Alerts</span><span class=\"text-muted fs-6\">Receive a notification if a payment is stated as risk by the Finance Department.</span></span><!--end::Label--></label><!--end::Option--><!--begin::Option--><div class=\"separator separator-dashed my-6\"></div><!--end::Option--><!--begin::Option--><label class=\"form-check form-check-custom form-check-solid align-items-start\"><!--begin::Input--><input class=\"form-check-input me-3\" type=\"checkbox\" name=\"email-preferences1\" checked value=\"1\"><!--end::Input--><!--begin::Label--><span class=\"form-check-label d-flex flex-column align-items-start\"><span class=\"fw-bold fs-5 mb-0\">Invoice Payments</span><span class=\"text-muted fs-6\">Receive a notification if a customer sends an incorrect amount to pay their invoice.</span></span><!--end::Label--></label><!--end::Option--><!--begin::Option--><div class=\"separator separator-dashed my-6\"></div><!--end::Option--><!--begin::Option--><label class=\"form-check form-check-custom form-check-solid align-items-start\"><!--begin::Input--><input class=\"form-check-input me-3\" type=\"checkbox\" name=\"email-preferences1\" value=\"1\"><!--end::Input--><!--begin::Label--><span class=\"form-check-label d-flex flex-column align-items-start\"><span class=\"fw-bold fs-5 mb-0\">Webhook API Endpoints</span><span class=\"text-muted fs-6\">Receive notifications for consistently failing webhook API endpoints.</span></span><!--end::Label--></label><!--end::Option--><!--begin::Option--><div class=\"separator separator-dashed my-6\"></div><!--end::Option--></div>", 1);
...
var _hoisted_599 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"d-flex flex-stack flex-grow-1\"><!--begin::Content--><div class=\"fw-semobold\"><h4 class=\"text-gray-800 fw-bold\"> You Are Deactivating Your Account </h4><div class=\"fs-6 text-gray-600\"> For extra security, this requires you to confirm your email or phone number when you reset yousignr password. <br><a class=\"fw-bold\" href=\"#\">Learn more</a></div></div><!--end::Content--></div>", 1);
