...
var chartOptions = function chartOptions(color, height) {
  var labelColor = (0,_assets_ts_utils__WEBPACK_IMPORTED_MODULE_1__.getCSSVariableValue)("--kt-gray-800");
  var baseColor = (0,_assets_ts_utils__WEBPACK_IMPORTED_MODULE_1__.getCSSVariableValue)("--kt-".concat(color));
  var lightColor = (0,_assets_ts_utils__WEBPACK_IMPORTED_MODULE_1__.getCSSVariableValue)("--kt-light-".concat(color));
  return {
    chart: {
      fontFamily: "inherit",
      type: "area",
...
var _hoisted_3 = {
  "class": "fw-bold text-primary my-6"
};
var _hoisted_4 = {
  "class": "text-dark-75 fw-semobold fs-5 m-0"
};
...
var _hoisted_3 = {
  href: "#",
  "class": "fw-bold text-dark fs-4 mb-2 text-hover-primary"
};
var _hoisted_4 = {
  "class": "fw-semobold text-muted fs-5"
};
var _hoisted_5 = ["src"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
...
var _hoisted_5 = {
  "class": "text-muted fw-semobold mt-1"
};
var _hoisted_6 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* TEXT */
    ...
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["bg-light-".concat(_ctx.color, " text-").concat(_ctx.color), "symbol-label fs-5 fw-bold"])
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* CLASS */
    ...
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["text-inverse-".concat(_ctx.color), "fw-bold fs-2 mb-2 mt-5"])
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.title), 3
  /* TEXT, CLASS */
  ), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["text-inverse-".concat(_ctx.color), "fw-semobold fs-7"])
...
var _hoisted_3 = {
  "class": "text-dark fs-1 fw-bold me-2"
};
var _hoisted_4 = {
  "class": "fw-semobold text-muted fs-7"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("begin: Statistics Widget 6"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    href: "#",
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["text-".concat(_ctx.color), "card-title fw-bold fs-5 mb-3 d-block"])
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.description), 3
  /* TEXT, CLASS */
